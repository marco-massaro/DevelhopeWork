...
public class Exercises {
    ...
    public static void exercise1() {
        ...
        int totalCount = 0;
        int luckyRolls = 0;
        for (int currentCount = 0; currentCount < 100; currentCount++) {
            while (rollD6() == 6) {
                luckyRolls++;
            }
    ...
    public static void exercise2() {
        ...
        exerciseLunch.setNameOfDayEaten("");
        exerciseLunch.setLunchWeightInGrams(500);
        exerciseLunch.setPrice(20.0);
     ...
     */
    private static final int MAX_WEEKS_IN_A_YEAR = 52;
    private static final int MAX_DAYS_IN_A_WEEK = 7;
    private static final int MAX_HOURS_IN_A_DAY = 24;
    public static void exercise4() {
        System.out.println("\nExercise 4:");

        for (int week = 0; week < MAX_WEEKS_IN_A_YEAR; week++) {
            for (int day = 0; day < MAX_DAYS_IN_A_WEEK; day++) {
                for (int hour = 0; hour < MAX_HOURS_IN_A_DAY; hour++) {
