...
public class Main {
    ...
    private static void exercise1() {
        ...
        int num = 10;
        num += 1;
        System.out.println("10 + 1 = " + num);
        num -= 1;
        System.out.println("11 - 1 = " + num);
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Write your code here
        double costTimes2 = 10.5;
        costTimes2 *= 2;
        System.out.println(costTimes2);
        double costDividedBy2 = 10.5;
        costDividedBy2 /= 2;
        System.out.println(costDividedBy2);
    }
    ...
    private static void exercise3() {
        ...
        System.out.println("The temp in celsius is " + celsius + " degrees C.");
        System.out.println("The temp in fahrenheit is " + fahrenheit + " degrees F.");
    ...
    private static void playAroundWithModulus() {
        ...
        int modulus = 6; // <--- and this value to see the results of modulus
