package javaoopAdvanced.exercises._1;
...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [apple, banana, kiwi, mango, orange] ask Marco why this is wrong. dovrebbe essere in ordine alfabetico?
    ...
    private static void exercise3() {
        ...
        for (Integer a : setA) {
            for (Integer b : setB) {
                if (a.equals(b)){  //I can do if(setA.contains(b)) but then I wouldn't need the NESTED for each loop.
