...
public class Exercises {
     ...
     * called 'name' and 'age'
     * <p>
     * Using the function below to set the student name and ages
     */
    ...
    private static void exercise3() {
        ...
        for (int i = 0; i < studentAges.size(); i++) {
            System.out.println(createNewStudent(studentNames.get(i), studentAges.get(i)));
            newCourse.students.add(createNewStudent(studentNames.get(i), studentAges.get(i)));
            sum += newCourse.students.get(i).age;
        }
        sum /= newCourse.students.size();
